  ...
  return (
    <APIProvider apiKey="AIzaSyCFkh_qWb43L2hFec0g-DcxvEUwDL0tSDE">
      <body className="w-full h-screen  bg-dark-0 overflow-hidden relative">
        <header className="bg-dark-0 fixed w-full z-50 shadow-md">
          ...
          <nav className="bg-transparent w-full flex justify-between px-8 lg:px-0 lg:justify-evenly items-center py-4">
            ...
            <div className="space-x-16  text-dark-400   hidden lg:flex xl:flex">
              <button className="text-blue-600 font-bold">Home</button>
              <button className="hover:text-blue-600">Sobre Nós</button>
              <button className="hover:text-blue-600">Serviços</button>
              <button className="hover:text-blue-600">Soluções</button>
              <button className="hover:text-blue-600">Contato</button>
            </div>
        ...
        <main className="w-full overflow-hidden bg-dark-0 ">
          ...
          >
            <article
              className="300 h-auto w-[calc(80vw)] md:w-auto md:h-full gap-0 
              ...
              <div className="grid md:grid-rows-[10%_90%]  w-[calc(40vw)] md:w-[calc(55vw)]  ">
                <div className="  row-start-2 gap-8 flex flex-col 400 w-[calc(80vw)] md:w-auto ">
                  ...
                  <div className="hidden md:flex gap-8 flex-col">
                    <p
                      className="text-dark-400 italic md:text-sm text-md lg:text-lg 
                  md:w-[calc(38vw)] lg:w-auto "
                    >
            ...
            <article
              className="600 flex flex-col gap-4  h-full items-center
            ...
            >
              <div
                className="banner-size w-full h-full justify-end flex flex-col 
              items-start md:pt-8 lg:mt-0 lg:items-start "
              >
                <div className=" w-full h-min relative flex justify-end ">
                  <Image
                    ...
                    alt={"phone-image"}
                    className={classNames(
                      "w-[calc(80vw)] md:w-[calc(50vw)] lg:w-[calc(45vw)] xl:w-[calc(40vw)] 2xl:w-[calc(35vw)] h-full "
                    )}
                  />
                </div>
          ...
          >
            <article
              className="col-start-2 w-full justify-start items-center 
              h-full flex row-start-1"
            >
              <div
                style={{
              ...
              <div
                className="row-start-1 h-full flex justify-center items-center  
                w-[calc(80vw)] lg:w-[calc(40vw)] "
              >
                <div
                  className="flex flex-col gap-y-8 text-dark-1000
                w-full lg:w-[calc(30vw)] "
                >
            ...
            <article
              className="col-start-2 w-full row-start-2
              h-full
              grid grid-rows-[45vh_75vh] sm:grid-rows-[60vh_60vh] lg:flex"
            >
              <div
                className="row-start-2 h-max lg:h-full 
                flex sm:justify-center lg:items-center
                  ...
                  {aboutItens.map((item, index) => (
                    <div className=" flex gap-x-4" key={item.alt}>
                      ...
                      <div className="flex flex-col gap-y-2">
                        ...
                        <p
                          className="italic text-md md:text-md 900 
                        w-full lg:w-[calc(30vw)] "
                        >
                          {item.text}
                        </p>
          ...
          {/* OUR SERVICES */}
          <section className="grid grid-cols-[10vw_80vw_10vw] h-[calc(250vh)] md:h-[calc(120vh)]  ">
            ...
            >
              {cards.map((item: any, index: any) => (
                <motion.div
                  ...
                  className=" h-96 md:h-[calc(35vh)] lg:h-[calc(40vh)] md:w-[calc(30vw)] lg:w-[calc(22vw)] xl:w-[calc(22vw)] px-6 py-6  bg-dark-0 z-40 
          ...
          {/* OUR SOLUTIONS */}
          <section
            className="100 mt-72 grid grid-cols-[10vw_80vw_10vw] h-[calc(150vh)] 
          grid-rows-[50vh_50vh]"
          >
            <article className=" row-start-1 h-[calc(25vh)] 2xl:h-auto 600 w-full col-start-2 ">
              <div
                className="400 flex flex-col gap-y-4 text-dark-1000 
              md:w-full lg:w-[calc(42vw)] "
              >
          ...
          >
            <article
              className="200 w-full h-full col-start-2 
            row-start-1 lg:row-start-2"
            >
              <div className="300 w-full lg:w-[calc(40vw)] 2xl:w-[calc(30vw)] h-full flex flex-col items-center ">
                <div className="400 flex flex-col gap-y-8 text-dark-1000 w-full">
                  <h6 className="text-5xl font-bold  w-full">Fale Conosco</h6>
                  <h6 className="text-md font-semibold w-full text-dark-900">
                    Sinta-se livre para contactar-nos a qualquer hora.
                    Entraremos em contato com você assim que pudermos.
                  </h6>
                </div>

                <div
                  className="500 w-full h-full 
                 flex flex-col justify-between gap-y-6 pt-12"
                >
                  <div className="flex flex-col gap-y-10">
                    <InputForm name={"nome"} icon={FaRegUser} />
                    <InputForm name={"email"} icon={MdOutlineMail} />
                    <InputForm name={"mensagem"} icon={BsChatRightTextFill} />
                  </div>
            ...
            >
              ...
              <div
                className="400 w-full lg:pl-12 flex
              justify-center lg:justify-start items-center "
              >
                <div
                  className="500 flex-col gap-y-8 
                w-[calc(60vw)] md:w-[calc(45vw)] lg:w-max flex 
                "
                >
            ...
            <div className="hidden lg:flex col-start-3 bg-blue-600 w-[calc(15vw)] z-10 right-0 h-full absolute"></div>
          </section>

          {/* FOOTER */}
          <footer
            className="bg-dark-1000 grid grid-cols-[5vw_90vw_5vw] lg:grid-cols-[10vw_80vw_10vw] grid-rows-1 w-full flex-col  text-dark-0 items-end justify-end  
          h-[calc(50vh)] md:h-[calc(30vh)]"
          >
            <div
              className="col-start-2 w-full 
              h-[calc(40vh)] md:h-[calc(25vh)]
            ...
            >
              <div
                className="h-full 
                w-[calc(80vw)] md:w-80
                row-start-1 items-center justify-between py-6"
              >
                <div className="flex flex-col gap-y-2">
              ...
              <div
                className="h-full md:h-16 flex 
                 items-center gap-x-8 md:gap-x-2 
                w-full md:w-80 justify-center md:justify-between
              row-start-2"
              >
                {icons.map((icon, i) => {
                  const Icon = icon.src;
